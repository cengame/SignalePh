...
WORKDIR /src
COPY ["SignalePh.csproj", "."]
RUN dotnet restore "./SignalePh.csproj"
COPY . .
WORKDIR "/src/."
RUN dotnet build "./SignalePh.csproj" -c $BUILD_CONFIGURATION -o /app/build

# Esta fase é usada para publicar o projeto de serviço a ser copiado para a fase final
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./SignalePh.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=true
